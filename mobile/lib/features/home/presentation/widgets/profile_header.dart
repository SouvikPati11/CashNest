...
/// Greeting header showing the signed-in user's avatar (initials) and name.
    ...
    return Row(
      children: [
        CircleAvatar(
          ...
          child: Text(
            _initials(name),
            style: context.textTheme.titleMedium?.copyWith(color: context.colors.onPrimaryContainer),
          ),
        ),
